  ...
  try {
    ...
    const options = {
      function: req.query.function
        ? parseInt(req.query.function as string)
        : undefined,
      filterSize: req.query.filterSize
        ? parseInt(req.query.filterSize as string)
        : undefined,
      frameDelta: req.query.frameDelta
        ? parseInt(req.query.frameDelta as string)
        : undefined,
      windowSize: req.query.windowSize
        ? parseInt(req.query.windowSize as string)
        : undefined,
      fftSize: req.query.fftSize
        ? parseInt(req.query.fftSize as string)
        : undefined,
      hopSize: req.query.hopSize
        ? parseInt(req.query.hopSize as string)
        : undefined,
    };
  ...
  try {
    ...
    const options = {
      ...
      threshold: req.query.threshold
        ...
        : undefined,
      minSliceLength: req.query.minSliceLength
        ? parseInt(req.query.minSliceLength as string)
        : undefined,
      filterSize: req.query.filterSize
        ? parseInt(req.query.filterSize as string)
        : undefined,
