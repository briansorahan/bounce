...
try {
...

  {
    ...
    console.log("PatternResult.toString: ✓");
  }
...

  {
    ...
    console.log("PatternResult.help: ✓");
  }
...

  {
    ...
    console.log("PatternResult.play (valid): ✓");
  }
...

  {
    ...
    console.log("PatternResult.play (channel 0): ✓");
  }
...

  {
    ...
    console.log("PatternResult.play (channel 9): ✓");
  }
...

  {
    ...
    console.log("PatternResult.stop (after play): ✓");
  }
...

  {
    ...
    console.log("PatternResult.stop (never played): ✓");
  }
...

  {
    ...
    console.log("PatternResult.toString (high velocity): ✓");
  }

} finally {
  // Restore original window — required by no-unguarded-global-mock rule
  (globalThis as Record<string, unknown>).window = originalWindow;
}

console.log("\nAll results-pattern tests passed.");
